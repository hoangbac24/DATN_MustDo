      ...
      <div className="w-full max-w-md rounded-2xl border border-white/10 bg-[#111827] p-6 shadow-2xl">
        <div className="flex items-center justify-between border-b border-white/10 pb-4">
          <div className="flex items-center space-x-2">
            ...
            <h3 className="text-lg font-bold text-white font-heading">Board Settings</h3>
          </div>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="mt-4 space-y-4">
          <div>
            <label className="block text-xs font-semibold text-gray-300">Board Name</label>
            <input
              type="text"
              value={name}
          ...
          <div>
            ...
            <textarea
              ...
              className="mt-1.5 w-full rounded-xl border border-white/10 bg-white/5 px-3.5 py-2 text-xs text-white focus:border-indigo-500 focus:outline-none resize-none"
            />
          </div>

          <div>
            <label className="block text-xs font-semibold text-gray-300">Column Width (px)</label>
            <input
              type="number"
              min="200"
              max="450"
          ...
          <div className="flex items-center justify-between py-2">
            <span className="text-xs font-semibold text-gray-300">Show Task Counter on Headers</span>
            <input
              type="checkbox"
