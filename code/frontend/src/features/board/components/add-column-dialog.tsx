    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-md p-4">
      <div className="w-full max-w-md rounded-2xl border border-white/10 bg-[#111827] p-6 shadow-2xl">
        <div className="flex items-center justify-between border-b border-white/10 pb-4">
          <h3 className="text-lg font-bold text-white font-heading">Add New Column</h3>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="mt-4 space-y-4">
          <div>
            <label className="block text-xs font-semibold text-gray-300">Column Title</label>
            <input
              type="text"
              value={name}
          ...
          <div>
            <label className="block text-xs font-semibold text-gray-300">Column Color</label>
          ...
          <div>
            <label className="block text-xs font-semibold text-gray-300">
              Work In Progress (WIP) Limit <span className="text-[10px] text-gray-400">(0 = unlimited)</span>
            </label>
            <input
              type="number"
              min="0"
